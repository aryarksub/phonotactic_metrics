...
pos_uni_bi_model = lmer(response ~ pos_uni_score * pos_bi_score + (1|word) + (1|ID), data = spanish_data)
...
pos_uni_bi_freq_smooth_model = lmer(response ~ pos_uni_score_freq_weighted_smoothed * pos_bi_score_freq_weighted_smoothed + (1|ID), data=spanish_data)
